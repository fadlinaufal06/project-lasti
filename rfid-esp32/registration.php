...
<html>
	<head>
		...
		<title>Registration : MATAHARI ITEM INFORMATION</title>
	</head>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a class="active" href="registration.php">Add Item</a></li>
				...
				<form class="form-horizontal" action="insertDB.php" method="post" >
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input name="add_info" type="text" placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="harga" type="text" placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="stok" type="text"  placeholder="" required>
						</div>
					</div>
